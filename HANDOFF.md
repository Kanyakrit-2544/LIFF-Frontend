...
`README.md` มี index ครบ · `docs/00`–`docs/19` · **`docs/13`** = สเปกที่เขียนให้ Codex เป็นตัวอย่างรูปแบบที่ใช้ได้ผล
...
**เสร็จแล้ว** S1–S10 · 182 tests ผ่าน · typecheck + build ผ่าน
...
| import WF-D ใหม่ + ผูก MongoDB credential | กลาง |
